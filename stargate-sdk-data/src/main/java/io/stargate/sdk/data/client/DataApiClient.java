...
public interface DataApiClient extends DataApiCommandRunner {
     ...
     *
     * @return A {@link java.util.stream.Stream<NamespaceInformation>} containing metadata about each namespace,
     ...
     *
     * @return A {@link CompletableFuture} that, when completed, will contain a {@link java.util.stream.Stream<NamespaceInformation>}
