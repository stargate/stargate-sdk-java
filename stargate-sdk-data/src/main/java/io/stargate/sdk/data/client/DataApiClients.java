...
import io.stargate.sdk.data.internal.DataApiClientImpl;
...
public class DataApiClients {
     ...
     *      token
     */
    public static DataApiClient create(@NonNull String endpoint, @NonNull String token, HttpClientOptions httpClientOptions) {
        Assert.notNull(endpoint, "endpoint");
        Assert.notNull(token, "token");
        Assert.notNull(httpClientOptions, "httpClientOptions");
        return new DataApiClientImpl(buildServiceDeployment(endpoint, new FixedTokenAuthenticationService(token)),  httpClientOptions);
    }
     ...
     */
    public static DataApiClient create(ServiceDeployment<ServiceHttp> serviceDeployment, HttpClientOptions clientOptions) {
        return new DataApiClientImpl(serviceDeployment, clientOptions);
    }
